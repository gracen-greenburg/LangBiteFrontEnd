...
public class HomePageController {
    ...
    @FXML private void continueToModule() throws IOException {
        ...
        Number grammarRulesCompletion = (Number) progress.getOrDefault("grammarRulesCompletionPercentage", 0);
        ...
        System.out.println("Grammar Rules Completion Percentage: " + grammarRulesCompletion); // Debugging output

        // Navigate based on progress
        if (mostCommonWordsCompletion.intValue() < 100) {
            System.out.println("Navigating to Most Common Words module");
            App.setRoot("mostcommonwords");
        } else if (connectorWordsCompletion.intValue() < 100) {
            System.out.println("Navigating to ConnectorWords module");
